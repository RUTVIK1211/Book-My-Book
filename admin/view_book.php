                   ...
                   <?php 
                        ...
                        while ($row = mysqli_fetch_assoc($result)) 
                        {
                          ...
                          echo "<td>".$row['b_category']."</td>";
                                echo "<td><a href='editb.php?id=".$row['b_id']."'><img src='images/edit.png' style='height:20px; width:20px' >Edit | <a href='process/delete_book.php?id=".$row['b_id']."'><img src='images/delete.png' style='height:20px; width:20px'>Delete </td>";
                          echo "</tr>";
                        }
                       ?>
                        </tbody>
